...
public final class SqliteReceiptStore implements ReceiptStore {
    private final DataSource dataSource;

    public SqliteReceiptStore(DataSource dataSource) {
    ...
    private void insertEvidenceLinks(Connection conn, ConfidenceReceipt receipt) throws Exception {
        ...
        String sql = "INSERT OR IGNORE INTO ts_receipt_evidence (receipt_id, evidence_id) VALUES (?, ?)";
