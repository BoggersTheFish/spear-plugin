...
|----------|-------------|
| [Overview](./overview.md) | SPEAR pattern mapping + executive summary |
| [Architecture Design](./architecture.md) | Full system design (1,300+ lines) |
| [Core Interfaces](./core-interfaces.md) | Port and engine contracts |
| [GUI Wireframes](./gui-wireframes.md) | Staff interface designs |
